...
public class DrinkActivit extends Activity {
    ...
    public void onFavoriteItemClicked(View view) {
        int drinkId = (int) getIntent().getExtras().get(EXTRA_DRINKID);
    ...
    private class  UpdateDrinkTask extends AsyncTask<Integer, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean success) {
            if (!success) {
                Toast toast = Toast.makeText(DrinkActivit.this, "Database unavoilable", Toast.LENGTH_SHORT);
                toast.show();
            }
        }
    }
